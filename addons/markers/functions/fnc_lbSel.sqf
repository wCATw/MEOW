...
/*
	Function: fnc_lbSel
		...
		Description:
			Handles selection changes in color and icon comboboxes, updating global parameters and UI previews accordingly.

		Arguments:
			_control    <Control>  - The combobox control.
			_lbCurSel   <Scalar>   - The selected index.

		Returns:
			none

		Variables:
			_num, _class, _slot_color, _slot_icon
*/
